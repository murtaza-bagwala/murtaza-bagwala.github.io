...
const CategoryTemplate=({data,pageContext})=>{const{title:siteTitle,subtitle:siteSubtitle}=(0,_hooks__WEBPACK_IMPORTED_MODULE_6__/* .useSiteMetadata */ .Q6)();const{category,currentPage,prevPagePath,nextPagePath,hasPrevPage,hasNextPage}=pageContext;const{edges}=data.allMarkdownRemark;const pageTitle=currentPage>0?`${category} - Page ${currentPage} - ${siteTitle}`:`${category} - ${siteTitle}`;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,{title:pageTitle,description:siteSubtitle},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Sidebar__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Page__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A,{title:category},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Feed__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A,{edges:edges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Pagination__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A,{prevPagePath:prevPagePath,nextPagePath:nextPagePath,hasPrevPage:hasPrevPage,hasNextPage:hasNextPage})));};const query="2562885128";/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CategoryTemplate);
...
;
//# sourceMappingURL=component---src-templates-category-template-js.js.map